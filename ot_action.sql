...
-- ----------------------------
INSERT INTO `ot_action_log` VALUES ('1', '1', '1', '2130706433', 'member', '1', 'root在2017-03-01 22:49登录了后台', '1', '1488379767');
INSERT INTO `ot_action_log` VALUES ('2', '1', '2', '2130706433', 'member', '2', 'xwh在2017-03-01 23:20登录了后台', '1', '1488381650');
INSERT INTO `ot_action_log` VALUES ('3', '1', '2', '2130706433', 'member', '2', 'xwh在2017-03-01 23:24登录了后台', '1', '1488381896');
INSERT INTO `ot_action_log` VALUES ('4', '1', '1', '2130706433', 'member', '1', 'root在2017-03-05 15:35登录了后台', '1', '1488699312');
INSERT INTO `ot_action_log` VALUES ('5', '6', '1', '2130706433', 'config', '38', '操作url：/admin.php?s=/Config/edit.html', '1', '1488700431');
...
INSERT INTO `ot_addons` VALUES ('9', 'SocialComment', '通用社交化评论', '集成了各种社交化评论插件，轻松集成到系统中。', '0', '{\"comment_type\":\"1\",\"comment_uid_youyan\":\"\",\"comment_short_name_duoshuo\":\"\",\"comment_data_list_duoshuo\":\"\"}', 'thinkphp', '0.1', '1380273962', '0');

-- ----------------------------
-- Table structure for ot_apps
-- ----------------------------
DROP TABLE IF EXISTS `ot_apps`;
CREATE TABLE `ot_apps` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `app_name` varchar(50) DEFAULT NULL COMMENT 'app的名称',
  `app_owner` int(11) DEFAULT NULL COMMENT 'app的拥有者id',
...
-- ----------------------------
INSERT INTO `ot_config` VALUES ('1', 'WEB_SITE_TITLE', '1', '网站标题', '1', '', '网站标题前台显示标题', '1378898976', '1379235274', '1', 'spider recorder', '0');
INSERT INTO `ot_config` VALUES ('2', 'WEB_SITE_DESCRIPTION', '2', '网站描述', '1', '', '网站搜索引擎描述', '1378898976', '1379235841', '1', 'spider recorder', '1');
INSERT INTO `ot_config` VALUES ('3', 'WEB_SITE_KEYWORD', '2', '网站关键字', '1', '', '网站搜索引擎关键字', '1378898976', '1381390100', '1', 'spider', '8');
...
-- ----------------------------
INSERT INTO `ot_document` VALUES ('1', '1', '', 'OneThink1.1开发版发布', '2', '0', '期待已久的OneThink最新版发布', '0', '0', '2', '2', '0', '0', '0', '1', '0', '0', '9', '0', '0', '0', '1406001413', '1406001413', '-1');
INSERT INTO `ot_document` VALUES ('2', '1', '', '点点滴滴', '2', '0', '', '0', '0', '2', '2', '0', '0', '0', '1', '0', '0', '11', '0', '0', '0', '1488707363', '1488707363', '1');
...
INSERT INTO `ot_document_article` VALUES ('2', '0', '啊实打实的啊实打实的', '', '0');
